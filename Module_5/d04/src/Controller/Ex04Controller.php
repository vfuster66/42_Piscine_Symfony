...
class Ex04Controller extends AbstractController
{
    ...
    #[Route('/ex04/insert-data', name: 'ex04_insert_data', methods: ['GET', 'POST'])]
    public function insertData(Request $request): Response
    {
        ...
        return $this->render('ex04/insert.html.twig', [
            'message' => $message,
        ]);
    }

    #[Route('/ex04/view-data', name: 'ex04_view_data', methods: ['GET'])]
    public function viewData(): Response
    {
        try {
            ...
            return $this->render('ex04/view.html.twig', [
                'persons' => $persons,
            ]);
        } catch (DBALException $e) {
            $this->logger->error('Database error: ' . $e->getMessage());
    ...
    public function delete(int $id): Response
    {
        try {
            ...
            if (!$person) {
                ...
                return $this->redirectToRoute('ex04_view_data');
            }
